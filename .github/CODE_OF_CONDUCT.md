...
To report a possible violation, please email the maintainer at
[4117458+RoFz@users.noreply.github.com](mailto:4117458+RoFz@users.noreply.github.com).

Community Moderators take reports of violations seriously and will make every
effort to respond in a timely manner. Enforcement actions are carried out in
private with the involved parties.

## Addressing and Repairing Harm

If an investigation finds that this Code of Conduct has been violated, the
following enforcement ladder may be used:

1. **Warning** — private written warning and request for repair.
2. **Temporarily Limited Activities** — time-limited cooldown period.
...
Adapted from the [Contributor Covenant 3.0](https://www.contributor-covenant.org/version/3/0/),
